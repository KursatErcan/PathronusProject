...
class Ui_Pathronus(object):
    ...
    def retranslateUi(self, Pathronus):
        ...
        self.PathronusMainText.setText(_translate("Pathronus", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; font-style:italic;\">Welcome to Pathronus Project. This project is created for a univercity</span></p><p align=\"center\"><span style=\" font-weight:600; font-style:italic;\">project by Pathronus group.</span></p><p><span style=\" font-weight:600; text-decoration: underline;\">Lesson:</span><span style=\" font-style:italic;\">Software Engineering</span></p><p><span style=\" font-weight:600; text-decoration: underline;\">Teacher: </span><span style=\" font-style:italic;\">Sedat Görmüş</span></p><p><span style=\" font-weight:600; text-decoration: underline;\">Group Members:</span></p><p><span style=\" font-style:italic;\">Ahmet Uğur Arıkan</span></p><p><span style=\" font-style:italic;\">Volkan Can Bacaksız</span></p><p><span style=\" font-style:italic;\">Kürşat Ercan</span></p><p><span style=\" font-style:italic;\">Burak Altuntaş</span></p><p><span style=\" font-weight:600; text-decoration: underline;\">IBAN For Donate: TR28 0011 1000 0000 0080 0089 02</span></p><p><span style=\" font-weight:600; text-decoration: underline;\">Connect: PathronusProject@gmail.com</span><br/></p></body></html>"))
